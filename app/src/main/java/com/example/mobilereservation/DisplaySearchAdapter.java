...
public class DisplaySearchAdapter extends ArrayAdapter<DataModel> implements View.OnClickListener {
    ...
    public DisplaySearchAdapter(int position, ArrayList<DataModel> data, Context context) {
